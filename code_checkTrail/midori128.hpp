...
std::vector<std::vector<std::pair<std::vector<uint8_t>, std::vector<uint8_t>>>> allInOutPairsMidori128(unsigned i, unsigned j);
...
bool existTrailMidori128(GRBModel & model,
				   modelData const & MD,
